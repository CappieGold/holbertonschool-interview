#!/usr/bin/python3
"""
Module that calculates the minimum number of operations to achieve n H characters
"""
...
def minOperations(n):
    ...
    If n is less than or equal to 1, returns 0 since no operations are needed or
